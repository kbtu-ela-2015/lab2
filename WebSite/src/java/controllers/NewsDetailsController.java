...
import models.NewsDetailsModel;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       RequestDispatcher requestDispatcher;
        ...
        Integer integer = Integer.parseInt(str1);
                request.setAttribute("page", "newsdetails");

        request.setAttribute("title", model.titles.get(integer-1));
        request.setAttribute("content", model.contents.get(integer-1));
